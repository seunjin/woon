...
export const searchEntries: SearchEntry[] = [
  ...
  },
  {
    ...
    group: 'Overlay',
    description: '드래그 제스처 · 스냅 포인트',
    keywords: ['bottomsheet', 'sheet', '바텀시트', 'drag', '드래그', 'snap', '스냅', 'mobile'],
  },
  // Floating
  {
    title: 'Tooltip',
  ...
  // Patterns
  {
    ...
    group: 'Patterns',
    description: 'Popover ↔ Bottom Sheet 자동 전환',
    keywords: ['adaptive', 'responsive', 'mobile', 'select', 'sheet', '반응형'],
  },
]
