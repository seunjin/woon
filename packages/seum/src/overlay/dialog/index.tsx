...
import { useSeumDialogContext } from '../../index'
...
function DialogOverlay({ children, style, onClick, ...props }: DialogOverlayProps) {
...
function DialogTitle({ asChild, children, ...props }: DialogTitleProps) {
...
function DialogDescription({ asChild, children, ...props }: DialogDescriptionProps) {
  const ctx = useDialogCompoundContext()
